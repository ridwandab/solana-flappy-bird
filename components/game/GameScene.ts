...
export class GameScene extends Phaser.Scene {
  ...
  private readonly PIPE_SPAWN_DELAY = 2500  // Balanced delay between pipes (2.5 seconds) for consistent gameplay
  private readonly PIPE_RESPAWN_X = 800
  private readonly BASE_PIPE_SPACING = 450  // Base distance between pipe sets (in pixels) - balanced spacing
  private readonly MIN_PIPE_SPACING = 450   // Minimum distance - same as base for consistent spacing
